...
const Navbar = () => {
    ...
    return (
        <header className="flex bg-transparent text-white text-xl z-50 justify-start sm:justify-between items-center min-h-[15vh] py-4 border-b-1 border-gray-300 w-full px-2 sm:px-24 absolute top-0 left-0">
